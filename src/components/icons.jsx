...
export function IconPantheon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path d="M12 3.5l1.8 3.9 4.2.5-3.1 2.9.9 4.2L12 12.9l-3.8 2.1.9-4.2-3.1-2.9 4.2-.5L12 3.5z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
      <circle cx="12" cy="17.5" r="3" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  )
}
