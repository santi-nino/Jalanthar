...
export const mockSources = [
  {
    "id": "src-infernal-ledger",
    "name": "The Infernal Ledger",
    "wares": [
      {
        "rowId": "row-fiend-1",
        "name": "Brimstone Rapier",
        "basePrice": 300,
        "description": "The blade smokes faintly and never quite cools; every cut smells of sulfur.",
        "category": "Weapon",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["Phlegethos"],"loadoutPool": "MagicWeapon"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-2",
        "name": "Contract-Bound Blade",
        "basePrice": 250,
        "description": "Fine, cruel, and etched along the fuller with clauses too small to read.",
        "category": "Weapon",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "MagicWeapon"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-3",
        "name": "Vial of Bottled Temptation",
        "basePrice": 150,
        "description": "Uncorked, it fills the air with whatever the nearest person wants most.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["Minauros"],"loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-4",
        "name": "Wax-Sealed Deal",
        "basePrice": 100,
        "description": "A folded contract, terms deliberately illegible until signed.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["Dis"],"loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-5",
        "name": "Cinder-Warm Signet",
        "basePrice": 120,
        "description": "A noble's ring, always a few degrees too hot to be comfortable.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["Dis"],"loadoutPool": "MagicItem"},
      ...
      {
        "rowId": "row-fiend-6",
        "name": "Mirror of Flattering Lies",
        "basePrice": 150,
        "description": "Shows the viewer exactly the face they wish they had.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-7",
        "name": "Coal-Black Rosary",
        "basePrice": 80,
        "description": "Beads warm to the touch, worn smooth by obsessive counting.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-8",
        "name": "Smoldering Perfume Vial",
        "basePrice": 90,
        "description": "The scent lingers on anyone it touches -- and on anyone they later meet.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-9",
        "name": "Whispering Contract Scroll",
        "basePrice": 200,
        "description": "Reads itself aloud in a voice that sounds uncomfortably reasonable.",
        "category": "Scroll",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-10",
        "name": "Flask of Sulfur Brandy",
        "basePrice": 15,
        "description": "Burns on the way down in a way that isn't entirely the alcohol.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-11",
        "name": "Infernal Vintage Wine",
        "basePrice": 40,
        "description": "Bottled centuries ago by someone who no longer exists, technically.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-12",
        "name": "Branding Iron, Cold",
        "basePrice": 20,
        "description": "Never needs heating -- it burns its mark regardless.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-13",
        "name": "Broken Manacle Link",
        "basePrice": 1,
        "description": "Snapped clean through, edges still sharp.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-14",
        "name": "Scorched Parchment Scrap",
        "basePrice": 0.5,
        "description": "Most of the writing is gone. What's left doesn't look encouraging.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-15",
        "name": "Cracked Hourglass (runs backward)",
        "basePrice": 2,
        "description": "Sand falls upward. Nobody's fixed it. Nobody's asked why.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-16",
        "name": "Goblet of Molten Gold",
        "basePrice": 400,
        "description": "Somehow always full, somehow never actually molten when you drink from it.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        ...
        "name": "Ruby-Eyed Idol",
        "basePrice": 600,
        "description": "A small figure of some minor devil lord, carved with unsettling care.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-18",
        "name": "Silk Robes, Blood-Dyed",
        "basePrice": 350,
        "description": "The dye never fully washed out -- or was never meant to.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-19",
        "name": "Crown of Lesser Devils",
        "basePrice": 800,
        "description": "Small horned faces are worked into the metal, all facing inward.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-20",
        "name": "Case of Sealed Contracts",
        "basePrice": 500,
        "description": "Each one bears a different signature, all in the same hand.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": ["magic-item"],
      ...
      {
        "rowId": "row-fiend-21",
        "name": "Fanged Maw, Preserved",
        "basePrice": 60,
        "description": "Jaws frozen mid-snarl, teeth still wickedly sharp.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["Pazunia"],"kind": "Trophy"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-22",
        "name": "Cracked Demon Skull",
        "basePrice": 50,
        "description": "Split down the middle, whatever was inside long gone.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
      ...
      {
        "rowId": "row-fiend-23",
        "name": "Curling Ichor-Slick Horn",
        "basePrice": 45,
        "description": "Still faintly wet, no matter how long it's been since the kill.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Horn"},
        "tags": [],
      ...
      },
      {
        ...
        "basePrice": 15,
        "description": "Snapped off close to the skull -- whatever did this hit hard.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Horn"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-25",
        "name": "Vial of Black Ichor",
        "basePrice": 30,
        "description": "Thicker than blood, and it never quite stops moving.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Ichor"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-26",
        "name": "Congealed Ichor Pool (jarred)",
        "basePrice": 25,
        "description": "Scooped up before it could soak into the ground.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Ichor"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-27",
        "name": "Scaled Demon Hide Swatch",
        "basePrice": 40,
        "description": "Rough and hot to the touch even after being cut free.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Hide"},
        "tags": [],
      ...
      },
      {
        ...
        "basePrice": 35,
        "description": "Stretched thin enough to see torchlight through.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Hide"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-29",
        "name": "Gnawed Bone Pile",
        "basePrice": 2,
        "description": "Not all the bones match the same species.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Den"},
        "tags": [],
      ...
      {
        "rowId": "row-fiend-30",
        "name": "Scorched Ritual Circle Fragment",
        "basePrice": 20,
        "description": "A wedge of stone, half a summoning sigil still legible on its face.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["The Blood Rift"],"kind": "Den"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-31",
        "name": "Cracked Summoning Sigil Stone",
        "basePrice": 35,
        "description": "Whatever it called probably answered.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {
          "realm": ["The Screaming Maze"],"kind": "Den"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-fiend-32",
        "name": "Broken Chain Link, Warm to Touch",
        "basePrice": 3,
        "description": "Whatever it used to bind is no longer bound.",
        "category": "Gear",
        "monsterTypeTags": ["Fiend"],
        "lootTags": {"kind": "Den"},
        "tags": [],
  ...
  {
    "id": "src-giants-hoard",
    "name": "The Giant's Hoard",
    "wares": [
      {
        "rowId": "row-giant-1",
        "name": "Waterskin, Giant-Sized",
        "basePrice": 3,
        "description": "Holds enough for a week -- for a giant, anyway.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      ...
      {
        "rowId": "row-giant-2",
        "name": "Sack of River Stones",
        "basePrice": 1,
        "description": "Smooth and fist-sized, good for throwing or just for the weight of them.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-3",
        "name": "Half-Eaten Boar Haunch",
        "basePrice": 1,
        "description": "Salted and wrapped in cloth, most of it still good.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-4",
        "name": "Bundle of Firewood, Massive",
        "basePrice": 2,
        "description": "Whole logs, not split -- a giant doesn't bother with kindling.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-5",
        "name": "Coil of Thick Rope",
        "basePrice": 5,
        "description": "Heavy-gauge, meant for hauling something a normal rope couldn't hold.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-6",
        "name": "Sharpening Stone, Fist-Sized",
        "basePrice": 3,
        "description": "Worn smooth on one face from constant use.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-7",
        "name": "Broken Cart Wheel",
        "basePrice": 1,
        "description": "Snapped clean off whatever it was pulling. The rest is nowhere in sight.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-8",
        "name": "Chewed Leather Strap",
        "basePrice": 0.5,
        "description": "Gnawed at one end, absentmindedly, by something with very large teeth.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-9",
        "name": "Dented Cookpot, Oversized",
        "basePrice": 4,
        "description": "Big enough to bathe in. Somebody probably has.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-10",
        "name": "Bag of Assorted Teeth",
        "basePrice": 2,
        "description": "Kept as trophies, or maybe just because they were there.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-11",
        "name": "Cracked Drinking Horn",
        "basePrice": 1,
        "description": "Leaks a little now, but still holds most of what's poured in.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-12",
        "name": "Tangle of Old Rope and Bone",
        "basePrice": 1,
        "description": "Knotted together so long ago nobody remembers why.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Junk"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-13",
        "name": "Chest of Plundered Coin and Trinkets",
        "basePrice": 500,
        "description": "Small treasures from a dozen different raids, never sorted or spent.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-14",
        "name": "Necklace of Rings, Strung Together",
        "basePrice": 150,
        "description": "Dozens of human-sized rings on a cord. Nobody's asked where they came from.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-15",
        "name": "Gilded War Horn",
        "basePrice": 300,
        "description": "Real gold leaf, hammered on unevenly by hands too big for the work.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-16",
        "name": "Tapestry, Torn from a Manor Wall",
        "basePrice": 200,
        "description": "Still shows most of the hunting scene. The frame didn't survive the trip.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-17",
        "name": "Case of Fine Wine, Looted",
        "basePrice": 120,
        "description": "A cellar's worth, crated and carried off whole.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-18",
        "name": "Ornamental Battle-Standard",
        "basePrice": 250,
        "description": "Taken from a warband that no longer needs it.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"loadoutPool": "Luxury"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-19",
        "name": "Boulder Sling, Reinforced",
        "basePrice": 15,
        "description": "A sling scaled up past any use a person could put it to. Simple, brutal, effective.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Hill"], "loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-20",
        "name": "Sack of Stolen Livestock Bells",
        "basePrice": 8,
        "description": "Still ring a little, muffled by the sacking. Whoever's flock this was is missing a few sheep.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Hill"], "loadoutPool": "Junk"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-21",
        "name": "Rune-Carved Standing Stone Shard",
        "basePrice": 40,
        "description": "Broken off something much larger. The carving continues right up to the break.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Stone"], "loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-22",
        "name": "Chisel Set, Massive",
        "basePrice": 20,
        "description": "Each chisel the size of a shortsword. Worn evenly, like they're used often.",
        "category": "Tool",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Stone"], "loadoutPool": "Supplementary"},
        "tags": [],
      ...
      {
        "rowId": "row-giant-23",
        "name": "Frost-Rimed War Horn",
        "basePrice": 25,
        "description": "Never fully thaws, even carried somewhere warm.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Frost"], "loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-24",
        "name": "Pelt of a Great White Bear",
        "basePrice": 180,
        "description": "Worn as a cloak; still smells faintly of the hunt.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Frost"], "loadoutPool": "Luxury"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-25",
        "name": "Ash-Streaked Forge Tongs",
        "basePrice": 18,
        "description": "Handles wrapped in scorched leather, still warm from the last use.",
        "category": "Tool",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Fire"], "loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-26",
        "name": "Ember-Warm Coal Sack",
        "basePrice": 3,
        "description": "Still faintly hot to the touch, hours after the forge.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Fire"], "loadoutPool": "Junk"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-27",
        "name": "Cloudstuff Rope, Coiled",
        "basePrice": 60,
        "description": "Lighter than it should be for its length. Doesn't quite sit flat when set down.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Cloud"], "loadoutPool": "Supplementary"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-28",
        "name": "Bag of Castle Keys, None Labeled",
        "basePrice": 10,
        "description": "Dozens of them, none matching anything nearby. Somewhere, doors are locked forever.",
        "category": "Gear",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Cloud"], "loadoutPool": "Junk"},
        "tags": [],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-29",
        "name": "Thundercloud-Charged Warhorn",
        "basePrice": 2000,
        "description": "Blown, it unleashes a deafening peal of thunder audible for miles, deafening anyone caught nearby for a short time.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Giant"],
        "lootTags": {"giantKind": ["Storm"], "loadoutPool": "MagicItem"},
        "tags": ["magic-item"],
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-giant-30",
        "name": "Lightning-Scarred Iron Gauntlet",
        "basePrice": 500,
  ...
  {
    "id": "src-dissolution-codex",
    "name": "The Dissolution Codex",
    "wares": [
      {
        "rowId": "row-ooze-1",
        "name": "Vial of Preserved Ooze Membrane",
        "basePrice": 3,
        "description": "A thin, rubbery sheet folded into a jar. Alchemists buy these by the dozen and never say why.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste" },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-2",
        "name": "Jar of Translucent Secretion",
        "basePrice": 5,
        "description": "Cloudy, faintly luminous, and it never quite settles at the bottom of the jar.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste" },
      ...
      {
        "rowId": "row-ooze-3",
        "name": "Sample of Ooze Core Matter",
        "basePrice": 8,
        "description": "Denser than the rest of the mass, and it holds its shape for a few hours after extraction before slumping flat.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste" },
      ...
      {
        "rowId": "row-ooze-4",
        "name": "Preserved Pseudopod Tissue",
        "basePrice": 4,
        "description": "Still faintly twitches if you poke it. Best kept sealed.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste" },
      ...
      {
        "rowId": "row-ooze-5",
        "name": "Bottled Digestive Fluid",
        "basePrice": 6,
        "description": "Thick, faintly bubbling, and it eats through the cork if you don't reseal it fast. Functions like a vial of Acid if thrown.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste" },
      ...
      {
        "rowId": "row-ooze-6",
        "name": "Vial of Concentrated Acid Secretion",
        "basePrice": 10,
        "description": "Drawn straight from the source and still fizzing faintly. Functions like a vial of Acid.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Acidic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-7",
        "name": "Sample of Metal-Eating Slime",
        "basePrice": 12,
        "description": "Kept in a lead-lined jar for good reason -- it's already started on the lid's rivets.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Corrosive"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-8",
        "name": "Jar of Living Adhesive",
        "basePrice": 15,
        "description": "Still faintly sticky through the glass. Craftsmen pay well for a controlled sample.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Adhesive"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-9",
        "name": "Vial of Caustic Residue",
        "basePrice": 10,
        "description": "Fumes faintly when the jar is opened. Handle with gloves.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Caustic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        ...
        "name": "Corroded Sword",
        "basePrice": 3,
        "description": "Most of the blade has thinned to almost nothing. Can function like a Dagger.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Corrosive"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-11",
        "name": "Rust-Fused Chainmail Scrap",
        "basePrice": 2,
        "description": "A fist-sized clump of links, welded together by whatever's been eating at them.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Corrosive"] },
      ...
      {
        "rowId": "row-ooze-12",
        "name": "Pitted Dagger, Acid-Etched",
        "basePrice": 2,
        "description": "The edge still holds despite the pitting all along the blade. Can function like a Dagger.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Acidic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-13",
        "name": "Half-Dissolved Leather Glove",
        "basePrice": 1,
        "description": "One glove, the fingertips gone entirely soft and thin.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Acidic"] },
      ...
      {
        "rowId": "row-ooze-14",
        "name": "Boot, Stuck Fast in Residue",
        "basePrice": 1,
        "description": "Still standing upright in a hardened puddle of the stuff. Whoever it belonged to left without it.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Adhesive"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-15",
        "name": "Coil of Tacky Residue-Coated Rope",
        "basePrice": 2,
        "description": "Unpleasant to handle, but it holds a knot better than clean rope ever did. Can function like Rope (50 feet).",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Adhesive"] },
      ...
      {
        "rowId": "row-ooze-16",
        "name": "Fume-Bleached Finger Bone",
        "basePrice": 1,
        "description": "Bleached white and slightly porous, like the fumes got into the marrow.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Caustic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-17",
        "name": "Chemical-Scarred Belt Buckle",
        "basePrice": 1,
        "description": "The plating's gone entirely in patches, down to dull, pitted metal.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Caustic"] },
      ...
      {
        "rowId": "row-ooze-18",
        "name": "Half-Dissolved Journal Page",
        "basePrice": 1,
        "description": "Most of the ink has run, but a few words near the top are still legible.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor" },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-19",
        "name": "Warped Holy Symbol, Barely Recognizable",
        "basePrice": 3,
        "description": "Soft at the edges now, the engraving worn down to a suggestion of what it used to be.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor" },
      ...
      {
        "rowId": "row-ooze-20",
        "name": "Bent Arrow, Partially Dissolved",
        "basePrice": 0.2,
        "description": "The fletching's gone soft, but the head's still sharp.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "Supplementary" },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-21",
        "name": "Corroded Coin Cluster",
        "basePrice": 4,
        "description": "A handful of coins fused into one lumpy mass. Still spends, once you pry them apart.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "Supplementary" },
      ...
      {
        "rowId": "row-ooze-22",
        "name": "Waterlogged Coin Purse",
        "basePrice": 2,
        "description": "The leather's gone soft and dark, but the drawstring still cinches.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "Supplementary" },
      ...
      {
        "rowId": "row-ooze-23",
        "name": "Dented Tin Cup, Swallowed Whole",
        "basePrice": 1,
        "description": "Not much worse for wear, all things considered.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "Supplementary" },
      ...
      {
        "rowId": "row-ooze-24",
        "name": "Slime-Coated Dagger, +1",
        "basePrice": 500,
        "description": "Recovered intact from the ooze's mass -- the enchantment kept the residue from eating through. Grants a +1 bonus to attack and damage rolls made with this weapon.",
        "category": "Weapon",
        "monsterTypeTags": ["Ooze"],
        "tags": ["magic-item"],
        "lootTags": { "kind": "Supplementary" },
      ...
      {
        "rowId": "row-ooze-25",
        "name": "Ring of Protection, Pitted but Functional",
        "basePrice": 3500,
        "description": "The band is scarred and discolored, but the enchantment survived the digestion intact. Grants a +1 bonus to Armor Class and to saving throws while worn.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Ooze"],
        "tags": ["magic-item"],
        "lootTags": { "kind": "Supplementary" },
      ...
      {
        "rowId": "row-ooze-26",
        "name": "Vial of Distilled Venom Sac",
        "basePrice": 11,
        "description": "Thick and faintly yellow, decanted straight from the source. Functions like a vial of basic poison.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Poisonous"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-27",
        "name": "Corroded Blowgun, Venom-Slicked",
        "basePrice": 8,
        "description": "The barrel's pitted but true. Can function like a Blowgun.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Poisonous"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-28",
        "name": "Ration Pack, Long Spoiled",
        "basePrice": 1,
        "description": "Whatever this was, it isn't food anymore. Best not to open it.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Poisonous"] },
      ...
      {
        "rowId": "row-ooze-29",
        "name": "Shard of Perpetual Frost-Slime",
        "basePrice": 9,
        "description": "Never fully thaws, even sealed somewhere warm. Alchemists prize the cold for its own sake.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Freezing"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-30",
        "name": "Frost-Split Dagger",
        "basePrice": 2,
        "description": "Cracked along the fuller from repeated freeze and thaw, but the edge held. Can function like a Dagger.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Freezing"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-31",
        "name": "Rime-Cracked Buckle",
        "basePrice": 1,
        "description": "The leather crumbled away first; the frost pattern etched into the metal never quite fades.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Freezing"] },
      ...
      {
        "rowId": "row-ooze-32",
        "name": "Vial of Charged Slime Residue",
        "basePrice": 10,
        "description": "Gives a faint, visible spark if the jar is tapped. Handle with dry gloves.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Electrified"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-33",
        "name": "Static-Fused Chain Links",
        "basePrice": 2,
        "description": "Welded together by something that clearly wasn't a forge.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Electrified"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-34",
        "name": "Scorched Copper Wire Coil",
        "basePrice": 2,
        "description": "Still carries the faintest tingle if you're not careful gripping it.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Electrified"] },
      ...
      {
        "rowId": "row-ooze-35",
        "name": "Jar of Putrescent Ichor",
        "basePrice": 7,
        "description": "The smell gets through the seal anyway. Nobody's asked why alchemists still buy it.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Putrescent"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-36",
        "name": "Rotted Leather Satchel",
        "basePrice": 1,
        "description": "Falls apart a little more every time it's handled. Whatever was inside is long gone.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Putrescent"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-37",
        "name": "Reeking Bone Fragment",
        "basePrice": 1,
        "description": "Ordinary bone, except for the smell, which is anything but.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Putrescent"] },
      ...
      {
        "rowId": "row-ooze-38",
        "name": "Chip of Half-Petrified Slime",
        "basePrice": 13,
        "description": "Stone on one side, still faintly soft on the other. Doesn't seem to be finishing the job.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "BiologicalWaste", "composition": ["Petrifying"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-ooze-39",
        "name": "Stone-Crusted Signet Ring",
        "basePrice": 4,
        "description": "The mineral crust can be picked away carefully; the ring underneath is still intact.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Petrifying"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        ...
        "name": "Calcified Boot",
        "basePrice": 1,
        "description": "Solid all the way through now. Whoever wore it isn't getting it back.",
        "category": "Gear",
        "monsterTypeTags": ["Ooze"],
        "tags": [],
        "lootTags": { "kind": "NarrativeFlavor", "composition": ["Petrifying"] },
  ...
  {
    "id": "src-herbalists-field-guide",
    "name": "The Herbalist's Field Guide",
    "wares": [
      {
        "rowId": "row-plant-1",
        "name": "Handful of Dried Petals",
        "basePrice": 1,
        "description": "Faded color, faint scent, useful mostly to a perfumer or a pressing-book.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora" },
        "priceOverride": "",
        "quantity": 1
      ...
      {
        "rowId": "row-plant-2",
        "name": "Bundle of Common Herbs",
        "basePrice": 2,
        "description": "Nothing rare, but a cook or a hedge-healer will always take more.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora" },
      ...
      {
        "rowId": "row-plant-3",
        "name": "Strip of Woody Bark",
        "basePrice": 1,
        "description": "Tough and fibrous, the kind tanners and basket-weavers both ask after.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora" },
      ...
      {
        "rowId": "row-plant-4",
        "name": "Sap-Sealed Resin Lump",
        "basePrice": 3,
        "description": "Hardened amber-gold, still faintly tacky at the center.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora" },
      ...
      {
        "rowId": "row-plant-5",
        "name": "Gnarled Root Cluster",
        "basePrice": 2,
        "description": "Twisted into a shape that's almost, but not quite, a face.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Rooted"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-6",
        "name": "Bundle of Fibrous Roots",
        "basePrice": 2,
        "description": "Tough enough to plait into a crude cord in a pinch.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Rooted"] },
      ...
      {
        "rowId": "row-plant-7",
        "name": "Broken Cactus Spike Cluster",
        "basePrice": 2,
        "description": "Snapped off near the base, still needle-sharp at the tips.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Rooted"], "environment": ["Desert"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-8",
        "name": "Frost-Hardened Deep Root",
        "basePrice": 3,
        "description": "Driven down past the frost line to reach anything worth reaching -- dense, cold, and stubborn.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Rooted"], "environment": ["Arctic/Tundra"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-9",
        "name": "Waterlogged Root Ball",
        "basePrice": 2,
        "description": "Never quite dries out, no matter how long it airs.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Rooted"], "environment": ["Swamp/Wetland"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-10",
        "name": "Stone-Gripping Root Tangle",
        "basePrice": 3,
        "description": "Wound so tightly around a chunk of rock that pulling them apart isn't worth the effort.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Rooted"], "environment": ["Mountain"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-11",
        "name": "Severed Tendril-Limb (Preserved)",
        "basePrice": 4,
        "description": "Root-like, but jointed -- clearly built for walking, not just anchoring.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Mobile"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-12",
        "name": "Bundle of Root-Feet",
        "basePrice": 3,
        "description": "Small, splayed, and worn smooth on the underside from years of dragging.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Mobile"] },
      ...
      {
        "rowId": "row-plant-13",
        "name": "Vine-Wrapped Walking Root",
        "basePrice": 4,
        "description": "Bound tight with its own vines, the way it must have moved through the canopy floor.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Mobile"], "environment": ["Jungle/Tropical"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-14",
        "name": "Drained Digestive Pod",
        "basePrice": 3,
        "description": "Whatever it caught, it's long finished with. Best handled with gloves regardless.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Carnivorous"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-15",
        "name": "Trap-Petal Fragment",
        "basePrice": 2,
        "description": "The inner surface is still faintly sticky, even pressed flat and dried.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Carnivorous"] },
      ...
      {
        "rowId": "row-plant-16",
        "name": "Chitin-Piercing Thorn Cluster",
        "basePrice": 3,
        "description": "Curved and hollow -- built to hold something down, not just to hurt.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Carnivorous"] },
      ...
      {
        "rowId": "row-plant-17",
        "name": "Withered Host Fragment",
        "basePrice": 2,
        "description": "Whatever this was attached to, it wasn't left much once the plant was through.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Parasitic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-18",
        "name": "Parasitic Root Filament",
        "basePrice": 2,
        "description": "Thin as thread and just as easy to miss, until you see how far it's spread.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Parasitic"] },
      ...
      {
        "rowId": "row-plant-19",
        "name": "Bloated Leech-Vine Pod",
        "basePrice": 4,
        "description": "Heavy with whatever it drained before someone cut it loose.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Parasitic"], "environment": ["Swamp/Wetland"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-20",
        "name": "Dried Mushroom Cap Bundle",
        "basePrice": 2,
        "description": "Tied in a neat row, the way any forager worth their salt would carry them.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Fungal"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-21",
        "name": "Preserved Spore Print",
        "basePrice": 2,
        "description": "Pressed onto dark paper and sealed under glass -- a mycologist's idea of a keepsake.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Fungal"] },
      ...
      {
        "rowId": "row-plant-22",
        "name": "Bioluminescent Cap Cluster",
        "basePrice": 5,
        "description": "Glows a faint, steady blue-green -- enough to read by in a truly dark cave.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Fungal"], "environment": ["Underground/Subterranean"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-23",
        "name": "Spore Bulb, Sealed",
        "basePrice": 15,
        "description": "Crack it open and it releases a thick, lingering cloud -- functions like a Bottle of Everlasting Smoke, but only lasts about 4 rounds before the spores settle.",
        "category": "Wondrous Item",
        "monsterTypeTags": ["Plant"],
        "tags": ["magic-item"],
        "lootTags": { "kind": "Flora", "lineage": ["Fungal"] },
      ...
      {
        "rowId": "row-plant-24",
        "name": "Handful of Soft Moss",
        "basePrice": 1,
        "description": "Springy and damp, good padding in a pinch.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Moss"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-25",
        "name": "Moss-Covered Bark Chip",
        "basePrice": 1,
        "description": "More moss than bark at this point, honestly.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Moss"] },
      ...
      {
        "rowId": "row-plant-26",
        "name": "Waterlogged Moss Clump",
        "basePrice": 1,
        "description": "Heavier than it looks, and it never fully wrings dry.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Moss"], "environment": ["Swamp/Wetland"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-27",
        "name": "Stone-Clinging Moss Patch",
        "basePrice": 2,
        "description": "Pulled up with a thin skin of rock still attached underneath.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Moss"], "environment": ["Mountain"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-28",
        "name": "Coil of Living Vine",
        "basePrice": 2,
        "description": "Still slightly green, still slightly stubborn about staying coiled.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Vine/Creeper"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-29",
        "name": "Thorn-Studded Vine Length",
        "basePrice": 2,
        "description": "Handle it wrong and you'll remember why it's called a bramble.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Vine/Creeper"] },
      ...
      {
        "rowId": "row-plant-30",
        "name": "Canopy Vine Coil, Fresh-Cut",
        "basePrice": 3,
        "description": "Cut fresh from high in the canopy -- surprisingly strong for how supple it still is. Can function like 50 feet of Rope.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Vine/Creeper"], "environment": ["Jungle/Tropical"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-31",
        "name": "Waterlogged Frond Bundle",
        "basePrice": 1,
        "description": "Limp and dripping, useless for much beyond kindling once dried.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Aquatic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-32",
        "name": "Drained Bladder-Pod",
        "basePrice": 2,
        "description": "Kept it afloat once. Empty now, and a little sad about it.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Aquatic"] },
      ...
      {
        "rowId": "row-plant-33",
        "name": "Salt-Cured Kelp Strand",
        "basePrice": 3,
        "description": "Tougher than it looks once cured -- sailors have used worse for lashings. Can function like Rope (50 feet).",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Aquatic"], "environment": ["Coastal/Aquatic"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-34",
        "name": "Bundle of Curved Thorns",
        "basePrice": 2,
        "description": "Hooked rather than straight -- these were built to catch, not just to poke.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Thorned/Bramble"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-35",
        "name": "Snarled Bramble Fragment",
        "basePrice": 1,
        "description": "A knot of thorned branch too tangled to be worth untangling.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Thorned/Bramble"] },
      ...
      {
        "rowId": "row-plant-36",
        "name": "Barbed Thorn Cluster, Dried",
        "basePrice": 4,
        "description": "Scattered underfoot, they still bite through a boot sole. Can function like a bag of Caltrops (20).",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Thorned/Bramble"] },
      ...
      {
        "rowId": "row-plant-37",
        "name": "Dried Puffball Sac",
        "basePrice": 2,
        "description": "Squeeze it and it collapses in a small, harmless puff of dust. Empty now.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Spore-Bearing"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-38",
        "name": "Sealed Spore Cloud Capsule",
        "basePrice": 3,
        "description": "Still full, and clearly not meant to be opened carelessly.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "lineage": ["Spore-Bearing"] },
      ...
      {
        "rowId": "row-plant-39",
        "name": "Numbing Spore Sachet",
        "basePrice": 12,
        "description": "The fine powder inside dulls skin it touches within moments. Functions like a dose of basic poison, applied rather than ingested.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": ["magic-item"],
        "lootTags": { "kind": "Flora", "lineage": ["Spore-Bearing"] },
      ...
      {
        "rowId": "row-plant-40",
        "name": "Carved Bark Tablet, First Words",
        "basePrice": 25,
        "description": "Whoever wrote on this was still learning how -- the awkward, deliberate carving of a mind newly given words. A curiosity, not a tool.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "origin": ["Awakened"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-plant-41",
        "name": "Blight-Blackened Petal",
        "basePrice": 3,
        "description": "Perfectly preserved, and perfectly wrong -- the black never fades, and the shape is subtly not what it should be.",
        "category": "Gear",
        "monsterTypeTags": ["Plant"],
        "tags": [],
        "lootTags": { "kind": "Flora", "origin": ["Cursed/Blighted"] },
        "priceOverride": "",
        "quantity": 1
      }
    ],
  ...
  {
    "id": "src-undead-ossuary",
    "name": "The Ossuary Ledger",
    "wares": [
      {
        "rowId": "row-undead-1",
        "name": "Handful of Grave Dust",
        "basePrice": 1,
        "description": "Fine, gray, and unnervingly cold no matter how long it's held.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains" },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-2",
        "name": "Yellowed Finger Bone",
        "basePrice": 1,
        "description": "Small enough to slip in a pocket, unsettling enough that most don't.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains" },
      ...
      {
        "rowId": "row-undead-3",
        "name": "Preserved Sinew Cord",
        "basePrice": 2,
        "description": "Dried leathery tissue, still surprisingly strong when braided.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains" },
      ...
      {
        "rowId": "row-undead-4",
        "name": "Cracked Rib Fragment",
        "basePrice": 1,
        "description": "Snapped clean, the break edges worn smooth by time.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains" },
      ...
      },
      {
        ...
        "basePrice": 5,
        "description": "Shrunken to a fraction of its size, papery to the touch, still faintly shaped like what it was.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "minRank": 1 },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-6",
        "name": "Petrified Marrow Shard",
        "basePrice": 8,
        "description": "Bone gone stone-hard clean through, centuries deep in the animating process.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "minRank": 2 },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-7",
        "name": "Undying Ember Core",
        "basePrice": 20,
        "description": "A knot of tissue at the body's center that has never gone fully cold, no matter how many centuries pass.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "minRank": 3 },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-8",
        "name": "Rotted Flesh Strip",
        "basePrice": 1,
        "description": "Gray-green and sloughing, best handled with something other than bare hands.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Zombie"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-9",
        "name": "Bloated Stomach Sac",
        "basePrice": 2,
        "description": "Distended and foul -- whatever it last consumed, best not to ask.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Zombie"] },
      ...
      {
        "rowId": "row-undead-10",
        "name": "Rattling Finger Bones, Strung",
        "basePrice": 2,
        "description": "Threaded on old cord, they click together with every step a skeleton took.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Skeleton"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-11",
        "name": "Intact Ribcage Fragment",
        "basePrice": 3,
        "description": "Bleached bone, still faintly articulated at the joints.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Skeleton"] },
      ...
      {
        "rowId": "row-undead-12",
        "name": "Ghoul-Claw Talon",
        "basePrice": 3,
        "description": "Yellowed and hooked, worn from tearing through grave soil.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Ghoul"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        ...
        "name": "Blackened Fang",
        "basePrice": 2,
        "description": "Rotted at the root but still sharp at the tip.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Ghoul"] },
      ...
      {
        "rowId": "row-undead-14",
        "name": "Frost-Rimed Bone Shard",
        "basePrice": 4,
        "description": "Cold enough to sting bare skin, and never seems to warm.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Wight"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        ...
        "name": "Chilled Marrow",
        "basePrice": 5,
        "description": "Drawn from deep within the bone, it stays slushy no matter the season.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Wight"] },
      ...
      {
        "rowId": "row-undead-16",
        "name": "Wisp of Captured Mist",
        "basePrice": 6,
        "description": "Sealed in a jar, it swirls on its own even in still air.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Wraith"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-17",
        "name": "Shard of Congealed Shadow",
        "basePrice": 7,
        "description": "Darker than the space around it, cool to the touch, faintly resistant to light.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "Remains", "descent": ["Wraith"] },
      ...
      {
        "rowId": "row-undead-18",
        "name": "Rotted Burial Shroud",
        "basePrice": 2,
        "description": "Once fine linen, now little more than a stained rag.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods" },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-19",
        "name": "Corroded Iron Chain Link",
        "basePrice": 1,
        "description": "Snapped off something longer -- a gate, a binding, a grave marker's tether.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods" },
      ...
      {
        "rowId": "row-undead-20",
        "name": "Tarnished Holy Symbol, Broken",
        "basePrice": 3,
        "description": "Whatever faith buried this one, it didn't take.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods" },
      ...
      {
        "rowId": "row-undead-21",
        "name": "Cracked Funerary Urn",
        "basePrice": 4,
        "description": "Its contents spilled long ago, but the craftsmanship still shows.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods", "minRank": 1 },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-22",
        "name": "Rusted Grave-Marker Spike",
        "basePrice": 2,
        "description": "Driven deep once, now loose enough to pull free with a good tug.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods" },
      ...
      {
        "rowId": "row-undead-23",
        "name": "Waterlogged Coin Purse, Empty",
        "basePrice": 1,
        "description": "Whatever it held is long gone -- scavenged, or simply rotted away with everything else.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods", "descent": ["Zombie"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-24",
        "name": "Ancient Sword Hilt, Blade Long Gone",
        "basePrice": 3,
        "description": "The grip still holds a shape, but the metal it once carried has rusted to nothing.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods", "descent": ["Skeleton"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-25",
        "name": "Frozen Battle Standard Fragment",
        "basePrice": 6,
        "description": "A torn scrap of banner, stiff with permanent frost, still bearing a half-legible sigil.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods", "descent": ["Wight"], "minRank": 2 },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-26",
        "name": "Shattered Mirror Shard",
        "basePrice": 5,
        "description": "A jagged sliver that never quite reflects what's standing in front of it.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods", "descent": ["Wraith"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-27",
        "name": "Reliquary of the First Death",
        "basePrice": 30,
        "description": "Impossibly old, sealed shut, and still faintly warm at its core -- whatever it holds has never been identified.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "kind": "GraveGoods", "minRank": 3 },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-28",
        "name": "Blood-Stained Locket",
        "basePrice": 15,
        "description": "Holds a portrait of someone who died a very long time ago -- possibly the wearer, before.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Blood Caster", "Fledgling", "Ancient Sire"], "loadoutPool": "PersonalEffects", "descent": ["Vampire"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-29",
        "name": "Silver Mirror, Fogged",
        "basePrice": 20,
        "description": "Carried out of old habit rather than use -- it shows nothing when held up to its owner.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Blood Caster", "Fledgling", "Ancient Sire"], "loadoutPool": "PersonalEffects", "descent": ["Vampire"] },
      ...
      {
        "rowId": "row-undead-30",
        "name": "Torn Wolf-Pelt Cloak",
        "basePrice": 10,
        "description": "Coarse fur, ragged at the hem, smelling faintly of the hunt.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Werewolf", "Wererat", "Weretiger", "Werebear"], "loadoutPool": "PersonalEffects", "descent": ["Lycanthrope"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-31",
        "name": "Silver-Warded Collar, Broken",
        "basePrice": 12,
        "description": "Once meant to bind or contain -- the clasp is snapped, whatever held it has long since escaped.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Werewolf", "Wererat", "Weretiger", "Werebear"], "loadoutPool": "PersonalEffects", "descent": ["Lycanthrope"] },
      ...
      {
        "rowId": "row-undead-32",
        "name": "Phylactery Fragment, Inert",
        "basePrice": 50,
        "description": "A broken-off piece of something built to cheat death -- the enchantment binding it has long since guttered out.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Archlich", "Death Priest"], "loadoutPool": "PersonalEffects", "descent": ["Lich"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-33",
        "name": "Dust-Choked Spellbook Page",
        "basePrice": 8,
        "description": "A single loose page, the ink faded but the diagrams still faintly legible.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Archlich", "Death Priest"], "loadoutPool": "PersonalEffects", "descent": ["Lich"] },
      ...
      {
        "rowId": "row-undead-34",
        "name": "Faded Wedding Ring",
        "basePrice": 5,
        "description": "Worn thin at the band -- whoever wore this held onto it for a very long time.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Vengeful Spirit", "Poltergeist"], "loadoutPool": "PersonalEffects", "descent": ["Ghost"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-35",
        "name": "Cracked Portrait Locket",
        "basePrice": 6,
        "description": "The painted face inside has faded to little more than a suggestion.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Vengeful Spirit", "Poltergeist"], "loadoutPool": "PersonalEffects", "descent": ["Ghost"] },
      ...
      {
        "rowId": "row-undead-36",
        "name": "Canopic Jar Shard",
        "basePrice": 10,
        "description": "Painted with a stylized guardian face, broken from a set of four.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Mummy Lord", "Tomb Guardian"], "loadoutPool": "PersonalEffects", "descent": ["Mummy"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-37",
        "name": "Gilded Funerary Mask Fragment",
        "basePrice": 25,
        "description": "Beaten gold leaf over wood, cracked but still gleaming under the grave dust.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Mummy Lord", "Tomb Guardian"], "loadoutPool": "PersonalEffects", "descent": ["Mummy"] },
      ...
      {
        "rowId": "row-undead-38",
        "name": "Oath-Scarred Dog Tag",
        "basePrice": 5,
        "description": "Etched with a name and a vow -- both still legible, both still unfinished.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "role": ["Vengeance-Bound"], "loadoutPool": "PersonalEffects", "descent": ["Revenant"] },
        "priceOverride": "",
        "quantity": 1
      },
      {
        "rowId": "row-undead-39",
        "name": "Vial of Preserved Grave Moss",
        "basePrice": 3,
        "description": "Harvested from somewhere it shouldn't still be growing.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "loadoutPool": "Supplementary" },
      ...
      {
        "rowId": "row-undead-40",
        "name": "Bundle of Bone Needles",
        "basePrice": 2,
        "description": "Carved smooth, still sharp enough to use.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "loadoutPool": "Supplementary" },
      ...
      {
        "rowId": "row-undead-41",
        "name": "Wax-Sealed Letter, Undelivered",
        "basePrice": 4,
        "description": "Addressed to someone who is very likely also dead by now.",
        "category": "Gear",
        "monsterTypeTags": ["Undead"],
        "tags": [],
        "lootTags": { "loadoutPool": "Supplementary" },
      ...
      {
        "rowId": "row-undead-42",
        "name": "Antique Gold Torc",
        "basePrice": 100,
        "description": "Heavy, old-world craftsmanship -- the kind of piece a noble house would recognize on sight.",
        "category": "Gear",
        "monsterTypeTags": ["Undead", "Humanoid", "Giant", "Fiend"],
        "tags": [],
        "lootTags": { "loadoutPool": "Luxury" },
        "priceOverride": "",
        "quantity": 1
      ...
      {
        "rowId": "row-undead-43",
        "name": "Uncut Sapphire Cluster",
        "basePrice": 150,
        "description": "Rough and unpolished, but even untrained eyes can tell it's worth a fortune.",
        "category": "Gear",
        "monsterTypeTags": ["Undead", "Humanoid", "Giant", "Fiend"],
        "tags": [],
        "lootTags": { "loadoutPool": "Luxury" },
      ...
      {
        "rowId": "row-undead-44",
        "name": "Silk-Wrapped Ceremonial Dagger, Ornamental",
        "basePrice": 200,
        "description": "Too finely made for combat -- this was built to be displayed, not swung.",
        "category": "Gear",
        "monsterTypeTags": ["Undead", "Humanoid", "Giant", "Fiend"],
        "tags": [],
        "lootTags": { "loadoutPool": "Luxury" },
